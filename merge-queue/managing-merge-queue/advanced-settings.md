...
[Integrate Trunk Merge Queue with Slack ](broken-reference)to deliver real-time updates about your pull requests and queue status. You can configure notifications at two levels:&#x20;
