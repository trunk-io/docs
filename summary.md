...
* [Merge](merge/readme.md)
  ...
  * [Legacy Merge](merge/merge/readme.md)
    * [Getting Started](merge/merge/getting-started.md)
    * [Configuration](merge/merge/configuration.md)
    * [Using the Webapp](merge/merge/using-the-webapp.md)
    * [Integration for Slack](merge/merge/integration-for-slack.md)
    * [Reference](merge/merge/reference.md)
