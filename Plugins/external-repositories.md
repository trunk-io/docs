...
See our documentation on [custom linters](../overview-2/custom-linters.md) and [custom parsers](../overview-2/custom-parsers.md) for more on what you can do, such as writing your parser in Javascript or Python!
