...
This will scan your repository and create a `.trunk/trunk.yaml` file which enables all the linters, formatters, and security analyzers that [Trunk C](code-quality.md)[ode Quality ](code-quality.md)recommends.
