...
See our documentation on [custom linters](../../../linters/custom-linters.md) and [custom parsers](../lint/output-parsing.md) for more on what you can do, such as writing your parser in Javascript or Python!
