...
Check out how to [install the CLI](../advanced-setup/cli/install-trunk.md), [set it up in CI](../ci/get-started/github-integration.md), [ignore issues](../configuration/ignoring-issues.md), and set up [Custom Linters](../configuration/integrating-linters/).
