...
Check out how to [install the CLI](../cli/install-trunk.md), [set it up in CI](../get-started/github-integration.md), [ignore issues](../ignoring-issues.md), and set up [Custom Linters](../custom-linters.md).
