...
1. [Module inspection](https://github.com/terraform-linters/tflint/blob/master/docs/user-guide/module-inspection.md), [deep Checking](https://github.com/terraform-linters/tflint-ruleset-aws/blob/master/docs/deep_checking.md), and setting variables are not currently supported.
...
Ansible-lint must be configured with a trigger. See the [trigger rules](../check/configuration.md)#trigger-rules) documentation for more information.
