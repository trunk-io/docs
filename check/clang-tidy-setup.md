...
[More](configuration/configuring-existing-linters.md#clang-tidy) on working with Clang Tidy and Trunk Check
...
[More](configuration/configuring-existing-linters.md#using-bazel) on working with Bazel & Trunk Check.
