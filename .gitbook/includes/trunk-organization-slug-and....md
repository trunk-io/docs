...
You can find your token under **Settings > Organization > Manage > Organization API Token > View Organization API Token > View**. Since this is a secret, do not leak it publicly. Make sure you get your _organization token_, not your project/repo token.
