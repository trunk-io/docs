...
You can specify one of our built-in runtimes (`node`, `python`, ...) or a system runtime that you define. See the [runtimes documentation](doc:reference-trunk-yaml#runtimes) for more information.
