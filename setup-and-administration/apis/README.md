...
* [Merge API](../../merge-queue/reference/merge.md): for submitting and managing PRs in the merge queue, and for creating, configuring, and deleting merge queues programmatically.
