...
If your CI environment is setup to (https://blog.bazel.build/2023/10/06/bwob-in-bazel-7.html)[build without the bytes], you will need the following flag to pull the reports from the remote execution engine:
