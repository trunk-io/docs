...
You'll need to upload the JUnit reports generated by your CI jobs to Trunk so Trunk can [detect flaky tests](../../detection/) and [report them to the dashboard](../../dashboard.md). See [CI Providers](../ci-providers/) for a guide on how to upload test results to Trunk.
