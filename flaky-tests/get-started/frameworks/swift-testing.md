...
By the end of this guide, you should achieve the following before proceeding to the [next steps](swift-testing.md#next-step) to configure your CI provider.
