...
If automated detection hasn't caught a test you know is flaky, you can manually [flag it as flaky](detection.md#flag-as-flaky) from the test detail page. Flagged tests are treated as flaky regardless of automated monitor state, and the flag can be removed at any time.
